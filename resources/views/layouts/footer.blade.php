                    ...
                    <div class="footer-widget">
                        ...
                        <div class="footer-widget-body">
                            <p>Here you can read some details about a nifty little lifecycle of your order's journey
                                from the time you place your order to your new treasures arriving at your doorstep.
                            </p>
                        </div>
                        ...
                        <div class="footer-widget-body">
                            <p>It is equally important to choose the solution which offers a specific selection of
                                credit cards. We take Visa & MasterCard as they are widely used by cyber customers.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        <div class="footer-widget-title">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="{{ asset('public/web/img/logo/logo.jpg') }}" height="90px"
                                        alt="">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 order-2 order-md-1">
                        <div class="copyright-text">
                            <p>&copy; <b>AAKHET </b> All Right Reserved</a></p>
                        </div>
                    </div>
                    <div class="col-md-6 ms-auto order-1 order-md-2">
                        <div class="footer-payment">
                            <img src="{{ asset('public/web/img/payment.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
